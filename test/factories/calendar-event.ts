...
import { type CalendarEvent, type CalendarEventInput } from '@/lib/schemas/calendar-event';
...
export const calendarEventVariants = {
  intro: () => calendarEventFactory.build({ 
    title: 'Intro Meeting',
    description: 'Introduction meeting',
  }),
  
  followUp: () => calendarEventFactory.build({ 
    title: 'Follow-up Meeting',
    description: 'Follow-up discussion',
  }),
  
  consultation: () => calendarEventFactory.build({ 
    title: 'Consultation',
