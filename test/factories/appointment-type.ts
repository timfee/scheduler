...
export const appointmentTypeVariants = {
  intro: () => appointmentTypeFactory.build({
    name: 'Intro',
    description: 'Introduction meeting',
    durationMinutes: 30,
  }),
  
  followUp: () => appointmentTypeFactory.build({
    name: 'Follow-up',
    description: 'Follow-up meeting',
    durationMinutes: 30,
  }),
  
  consultation: () => appointmentTypeFactory.build({
    name: 'Consultation',
    description: 'Consultation session',
    durationMinutes: 60,
  }),
  
  briefing: () => appointmentTypeFactory.build({
    name: 'Briefing',
  ...
  inactive: () => appointmentTypeFactory.build({
    isActive: false,
  }),
