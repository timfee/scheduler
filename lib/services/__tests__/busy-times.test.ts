...
describe("busy-times service", () => {
  ...
  beforeEach(async () => {
    ...
    getBookingCalendar =
      integrationsModule.getBookingCalendar as jest.MockedFunction<any>;
    createDAVClientFromIntegration =
      integrationsModule.createDAVClientFromIntegration as jest.MockedFunction<any>;
    createCalDavProvider =
      caldavModule.createCalDavProvider as jest.MockedFunction<any>;
    mapErrorToUserMessage =
      errorsModule.mapErrorToUserMessage as jest.MockedFunction<any>;
  ...
  describe("listBusyTimesAction", () => {
    ...
    it("should return busy times when integration is available", async () => {
      ...
      expect(createDAVClientFromIntegration).toHaveBeenCalledWith(
        mockIntegration,
      );
      expect(createCalDavProvider).toHaveBeenCalledWith(
        mockClient,
