...
describe('Appointment Type Validation Utils', () => {
  ...
  describe('validateAppointmentTypeDuration', () => {
    ...
    it('should throw error with duration less than 1', () => {
      expect(() => validateAppointmentTypeDuration(0)).toThrow('Duration must be between 1 and 480 minutes');
    });

    it('should throw error with negative duration', () => {
      expect(() => validateAppointmentTypeDuration(-1)).toThrow('Duration must be between 1 and 480 minutes');
      expect(() => validateAppointmentTypeDuration(-30)).toThrow('Duration must be between 1 and 480 minutes');
    });

    it('should throw error with duration greater than 480', () => {
      expect(() => validateAppointmentTypeDuration(481)).toThrow('Duration must be between 1 and 480 minutes');
      expect(() => validateAppointmentTypeDuration(500)).toThrow('Duration must be between 1 and 480 minutes');
    });

    it('should throw error with duration much greater than 480', () => {
      expect(() => validateAppointmentTypeDuration(1000)).toThrow('Duration must be between 1 and 480 minutes');
    });
  });
